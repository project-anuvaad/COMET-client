...
if ["$1" = ""]; then
        ...
        echo " TAGGING WITH VERSION NUMBER " + $CI_REGISTRY/$SERVICE_NAMESPACE/$AWS_SERVICE_NAME:$RELEASE_VERSION_NUMBER
        docker tag  $BASE_REPO/$SERVICE_NAMESPACE/$AWS_SERVICE_NAME:${CI_COMMIT_SHA} $CI_REGISTRY/$SERVICE_NAMESPACE/$AWS_SERVICE_NAME:$RELEASE_VERSION_NUMBER
