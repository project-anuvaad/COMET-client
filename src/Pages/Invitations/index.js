...
class Invitations extends React.Component {
    ...
    componentWillMount = () => {
        ...
        this.props.respondToOrganizationInvitation(organizationId, s, t, email);
    }
...
const mapDispatchToProps = (dispatch) => ({
    respondToOrganizationInvitation: (organizationId, status, token, email) => dispatch(actions.respondToOrganizationInvitation(organizationId, status, token, email)),
