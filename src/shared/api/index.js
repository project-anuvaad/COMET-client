...
export default {
    ...
    article: {
        ...
        updateProjectLeaders: (articleId) => `${APP_ENV.API_ROOT}/article/${articleId}/projectLeaders`,
    ...
    organization: {
        ...
        getUsersCounts: (params) => `${APP_ENV.API_ROOT}/user/count?${querystring.encode(params)}`,
