...
const NOTIFICATION_COMP_MAP = {
    ...
    'invited_to_translate_text': InviteToTranslate,
    'invited_to_translate_text_accepted': DefaultNotification,
    'invited_to_translate_text_declined': DefaultNotification,
