...
import EditVideoSpeedModal from './modals/EditVideoSpeedModal';
...
class EditorHeader extends Component {
  ...
  _renderUpdateButton() {
    ...
    return (
      <UpdateArticleModal title={this.props.article.title} wikiSource={this.props.article.wikiSource} onConfirm={this.props.onUpdateArticle} />
    )
  }
  ...
  _renderVideoSpeed = () => {
    if (!this.props.options.showVideoSpeed) return;
    return <EditVideoSpeedModal
            value={this.props.videoSpeed}
            onSubmit={this.props.onVideoSpeedChange}
            />
  }
