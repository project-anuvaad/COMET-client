...
class Editor extends Component {
  ...
  _render() {
    const { article, match, mode, uploadState, showSelectBaseLanguage, baseLanguages, selectedBaseLanguage } = this.props
    const title = match.params.title
      ...
      <div className='editor-container'>
        <div className={editorClasses}>
          ...
          <EditorHeader
            ...
            videoSpeed={this.props.videoSpeed}
            onVideoSpeedChange={this.props.onVideoSpeedChange}
            mode={mode}
          ...
          {/* Footer */}
          <EditorFooter
            showSelectBaseLanguage={showSelectBaseLanguage}
            selectedBaseLanguage={selectedBaseLanguage}
            baseLanguages={baseLanguages}
            onChangeBaseLanguage={this.props.onChangeBaseLanguage}
            currentSlideIndex={currentSlideIndex}
